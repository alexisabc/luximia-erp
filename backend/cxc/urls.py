...
from .views import (
    ...
    UserViewSet, GroupViewSet, TipoDeCambioViewSet, get_all_permissions, dashboard_stats,
    valor_por_proyecto_chart, upe_status_chart, generar_estado_de_cuenta_pdf,
    generar_estado_de_cuenta_excel, consulta_inteligente, get_latest_tipo_de_cambio,
    actualizar_tipo_de_cambio_hoy, importar_datos_masivos, importar_clientes, importar_upes, 
    importar_contratos, importar_pagos_historicos, export_proyectos_excel, export_clientes_excel,
...
urlpatterns = [
    # 1. Rutas específicas y personalizadas van primero
    path('dashboard-stats/', dashboard_stats, name='dashboard-stats'),
    path('charts/valor-por-proyecto/', valor_por_proyecto_chart,
         name='chart-valor-por-proyecto'),
