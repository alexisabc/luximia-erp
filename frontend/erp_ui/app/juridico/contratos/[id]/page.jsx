...
import MetodoPagoSelect from '@/components/features/finance/MetodoPagoSelect';
        ...
        { header: 'Comentarios', render: (pago) => pago.comentarios || '---' },
        {
            header: 'Acciones', render: (pago) => (
                <div className="flex items-center justify-end space-x-4">
                    {hasPermission('contabilidad.change_pago') && (
                    ...
                    {hasPermission('contabilidad.delete_pago') && (
        ...
        <div className="p-8 h-full flex flex-col space-y-8">
            <div className="flex justify-between items-center flex-shrink-0">
                ...
                <div className="flex items-center space-x-3">
                    {hasPermission('contabilidad.add_pago') && <button onClick={handleCreateClick} className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">+ Registrar Pago</button>}
                    <button
