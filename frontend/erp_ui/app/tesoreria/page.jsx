...
import {
    ...
    procesarCorte, conciliarMovimiento
...
export default function TesoreriaPage() {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const [cuentasRes, turnosRes] = await Promise.all([
                getCuentas(),
                getTurnosPendientes()
            ]);
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
            {/* Header */}
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-gray-900 mb-2">Tesorería</h1>
                <p className="text-gray-600">Gestión de cuentas bancarias y flujos de efectivo</p>
            </div>
