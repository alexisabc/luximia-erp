        ...
        <div className="p-8">
            <header className="mb-8 flex justify-between items-center">
                ...
                <div className="flex gap-4">
                    <button
                        onClick={() => alert("Ejecutando Depreciación Enero 2026... Póliza Generada.")}
                        className="bg-orange-600 text-white px-4 py-2 rounded-lg hover:bg-orange-700 shadow"
                    >
                        Cierre Mensual (Depreciación)
                    </button>
                    <button
