                    ...
                    <div key={field.name} className="space-y-1.5">
...

                        {
                            field.type === 'checkbox-group' ? (
                                <div className="p-3 border border-gray-200 dark:border-gray-700 rounded-xl bg-gray-50/50 dark:bg-gray-800/50 max-h-48 overflow-y-auto custom-scrollbar space-y-2">
                                    {field.withSelectAll && (
                                        <label className="flex items-center space-x-3 cursor-pointer p-1.5 hover:bg-white dark:hover:bg-gray-700 rounded-lg transition-colors">
                                            <input
                                                type="checkbox"
                                            ...
                                            />
                                            <span className="text-sm font-semibold text-gray-900 dark:text-white">Seleccionar Todos</span>
                                        </label>
                                    )}
                                    {field.options.map(option => (
                                        <label key={option.value} className="flex items-center space-x-3 cursor-pointer p-1.5 hover:bg-white dark:hover:bg-gray-700 rounded-lg transition-colors">
                                            <input
                                                type="checkbox"
                                ...
                                <div className="p-3 border border-gray-200 dark:border-gray-700 rounded-xl bg-gray-50/50 dark:bg-gray-800/50 max-h-64 overflow-y-auto custom-scrollbar space-y-4">
                                    {field.withSelectAll && (
                                        <label className="flex items-center space-x-3 cursor-pointer p-1.5 hover:bg-white dark:hover:bg-gray-700 rounded-lg transition-colors">
                                            <input
                                                type="checkbox"
                                ...
                                <div className="flex items-center p-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                                    <input
                                        type="checkbox"
                                        name={field.name}
                                        checked={!!formData[field.name]}
                                        onChange={onFormChange}
                                        className="w-5 h-5 rounded border-gray-300 text-blue-600 focus:ring-blue-500/20 focus:ring-offset-0"
                                    />
                                    <span className="ml-3 text-sm font-medium text-gray-700 dark:text-gray-300">{field.checkboxLabel}</span>
                                </div>
                            ) : field.type === 'select' ? (
                                <div className="relative">
                                    <select
                                        ...
                                        className="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200 appearance-none"
                                    >
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200 placeholder-gray-400"
                                />
                            )
                        }
                    </div>
