...
export default function ImportarEmpleadosPage() {
  ...
  const handleDownloadTemplate = () => {
    const headers = ['user_id','nombre_completo','puesto_id','departamento_id'];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await importarEmpleados(formData);
  ...
  return (
    <div className="p-8">
      <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-200 mb-8">Importación de Empleados</h1>
      <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg max-w-2xl mx-auto">
        <div className="flex justify-between items-center mb-4">
          <p className="text-gray-600 dark:text-gray-300">Sube un archivo <strong>.csv</strong> con datos de empleados.</p>
          <button
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-6">
            ...
            >
              {isUploading ? 'Procesando...' : 'Subir y Procesar Empleados'}
            </button>
          </div>
        </form>
